...
if ($noLogs || isset($_forced_from_dbo_)):
    foreach ($sqlLogs as $source => $logInfo):
        ...
        printf(
                '<br/><table class="table table-striped table-condensed table-bordered cake-sql-log" id="cakeSqlLog_%s" summary="Cake SQL Log" cellspacing="0">', preg_replace('/[^A-Za-z0-9_]/', '_', uniqid(time(), true))
        );
